...
import { DuckDBParserListener } from "./DuckDBParserListener.js";
import { DuckDBParserVisitor } from "./DuckDBParserVisitor.js";
import { SQLParserBase } from '../SQLParserBase';
export declare class DuckDBParser extends SQLParserBase {
    ...
    static readonly RULE_pragma_name = 95;
    static readonly RULE_signed_number = 96;
    static readonly RULE_pragma_value = 97;
    static readonly RULE_pragmastmt = 98;
    static readonly RULE_opttemp = 99;
    static readonly RULE_table_column_list = 100;
    static readonly RULE_opttableelementlist = 101;
    static readonly RULE_opttypedtableelementlist = 102;
    static readonly RULE_tableelementlist = 103;
    static readonly RULE_typedtableelementlist = 104;
    static readonly RULE_tableelement = 105;
    static readonly RULE_typedtableelement = 106;
    static readonly RULE_column_def = 107;
    static readonly RULE_compressionCluase = 108;
    static readonly RULE_storageCluase = 109;
    static readonly RULE_columnOptions = 110;
    static readonly RULE_colquallist = 111;
    static readonly RULE_colconstraint = 112;
    static readonly RULE_colconstraintelem = 113;
    static readonly RULE_nulls_distinct = 114;
    static readonly RULE_generated_when = 115;
    static readonly RULE_deferrable_trigger = 116;
    static readonly RULE_initially_trigger = 117;
    static readonly RULE_tablelikeclause = 118;
    static readonly RULE_tablelikeoptionlist = 119;
    static readonly RULE_tablelikeoption = 120;
    static readonly RULE_tableconstraint = 121;
    static readonly RULE_constraintelem = 122;
    static readonly RULE_opt_no_inherit = 123;
    static readonly RULE_opt_column_list = 124;
    static readonly RULE_opt_column_list_create = 125;
    static readonly RULE_column_list = 126;
    static readonly RULE_column_list_create = 127;
    static readonly RULE_opt_c_include = 128;
    static readonly RULE_key_match = 129;
    static readonly RULE_exclusionconstraintlist = 130;
    static readonly RULE_exclusionconstraintelem = 131;
    static readonly RULE_exclusionwhereclause = 132;
    static readonly RULE_key_actions = 133;
    static readonly RULE_key_update = 134;
    static readonly RULE_key_delete = 135;
    static readonly RULE_key_action = 136;
    static readonly RULE_optinherit = 137;
    static readonly RULE_optpartitionspec = 138;
    static readonly RULE_partitionspec = 139;
    static readonly RULE_part_params = 140;
    static readonly RULE_part_elem = 141;
    static readonly RULE_table_access_method_clause = 142;
    static readonly RULE_optwith = 143;
    static readonly RULE_oncommitoption = 144;
    static readonly RULE_opttablespace = 145;
    static readonly RULE_index_paramenters_create = 146;
    static readonly RULE_optconstablespace = 147;
    static readonly RULE_existingindex = 148;
    static readonly RULE_createstatsstmt = 149;
    static readonly RULE_alterstatsstmt = 150;
    static readonly RULE_createasstmt = 151;
    static readonly RULE_create_as_target = 152;
    static readonly RULE_opt_with_data = 153;
    static readonly RULE_creatematviewstmt = 154;
    static readonly RULE_create_mv_target = 155;
    static readonly RULE_optnolog = 156;
    static readonly RULE_refreshmatviewstmt = 157;
    static readonly RULE_createseqstmt = 158;
    static readonly RULE_alterseqstmt = 159;
    static readonly RULE_optseqoptlist = 160;
    static readonly RULE_optparenthesizedseqoptlist = 161;
    static readonly RULE_seqoptlist = 162;
    static readonly RULE_seqoptelem = 163;
    static readonly RULE_opt_by = 164;
    static readonly RULE_numericonly = 165;
    static readonly RULE_numericonly_list = 166;
    static readonly RULE_createplangstmt = 167;
    static readonly RULE_opt_trusted = 168;
    static readonly RULE_handler_name = 169;
    static readonly RULE_opt_inline_handler = 170;
    static readonly RULE_validator_clause = 171;
    static readonly RULE_opt_validator = 172;
    static readonly RULE_opt_procedural = 173;
    static readonly RULE_createtablespacestmt = 174;
    static readonly RULE_opttablespaceowner = 175;
    static readonly RULE_createextensionstmt = 176;
    static readonly RULE_create_extension_opt_list = 177;
    static readonly RULE_create_extension_opt_item = 178;
    static readonly RULE_alterextensionstmt = 179;
    static readonly RULE_alter_extension_opt_list = 180;
    static readonly RULE_alter_extension_opt_item = 181;
    static readonly RULE_alterextensioncontentsstmt = 182;
    static readonly RULE_createfdwstmt = 183;
    static readonly RULE_fdw_option = 184;
    static readonly RULE_fdw_options = 185;
    static readonly RULE_opt_fdw_options = 186;
    static readonly RULE_alterfdwstmt = 187;
    static readonly RULE_create_generic_options = 188;
    static readonly RULE_generic_option_list = 189;
    static readonly RULE_alter_generic_options = 190;
    static readonly RULE_alter_generic_option_list = 191;
    static readonly RULE_alter_generic_option_elem = 192;
    static readonly RULE_generic_option_elem = 193;
    static readonly RULE_generic_option_name = 194;
    static readonly RULE_generic_option_arg = 195;
    static readonly RULE_createforeignserverstmt = 196;
    static readonly RULE_opt_type = 197;
    static readonly RULE_foreign_server_version = 198;
    static readonly RULE_opt_foreign_server_version = 199;
    static readonly RULE_alterforeignserverstmt = 200;
    static readonly RULE_createforeigntablestmt = 201;
    static readonly RULE_importforeignschemastmt = 202;
    static readonly RULE_import_qualification_type = 203;
    static readonly RULE_import_qualification = 204;
    static readonly RULE_createusermappingstmt = 205;
    static readonly RULE_auth_ident = 206;
    static readonly RULE_alterusermappingstmt = 207;
    static readonly RULE_createpolicystmt = 208;
    static readonly RULE_alterpolicystmt = 209;
    static readonly RULE_alterprocedurestmt = 210;
    static readonly RULE_procedure_cluase = 211;
    static readonly RULE_procedure_action = 212;
    static readonly RULE_rowsecurityoptionalexpr = 213;
    static readonly RULE_rowsecurityoptionalwithcheck = 214;
    static readonly RULE_rowsecuritydefaulttorole = 215;
    static readonly RULE_rowsecurityoptionaltorole = 216;
    static readonly RULE_rowsecuritydefaultpermissive = 217;
    static readonly RULE_rowsecuritydefaultforcmd = 218;
    static readonly RULE_row_security_cmd = 219;
    static readonly RULE_createamstmt = 220;
    static readonly RULE_am_type = 221;
    static readonly RULE_createtrigstmt = 222;
    static readonly RULE_triggeractiontime = 223;
    static readonly RULE_foreachrow = 224;
    static readonly RULE_roworstatment = 225;
    static readonly RULE_triggerevents = 226;
    static readonly RULE_triggeroneevent = 227;
    static readonly RULE_triggerreferencing = 228;
    static readonly RULE_triggertransitions = 229;
    static readonly RULE_triggertransition = 230;
    static readonly RULE_transitionoldornew = 231;
    static readonly RULE_transitionrowortable = 232;
    static readonly RULE_transitionrelname = 233;
    static readonly RULE_triggerforspec = 234;
    static readonly RULE_triggerforopteach = 235;
    static readonly RULE_triggerfortype = 236;
    static readonly RULE_triggerwhen = 237;
    static readonly RULE_function_or_procedure = 238;
    static readonly RULE_triggerfuncargs = 239;
    static readonly RULE_triggerfuncarg = 240;
    static readonly RULE_optconstrfromtable = 241;
    static readonly RULE_constraintattributespec = 242;
    static readonly RULE_constraintattributeElem = 243;
    static readonly RULE_createeventtrigstmt = 244;
    static readonly RULE_event_trigger_when_list = 245;
    static readonly RULE_event_trigger_when_item = 246;
    static readonly RULE_event_trigger_value_list = 247;
    static readonly RULE_altereventtrigstmt = 248;
    static readonly RULE_enable_trigger = 249;
    static readonly RULE_createassertionstmt = 250;
    static readonly RULE_definestmt = 251;
    static readonly RULE_definition = 252;
    static readonly RULE_def_list = 253;
    static readonly RULE_def_elem = 254;
    static readonly RULE_def_arg = 255;
    static readonly RULE_old_aggr_definition = 256;
    static readonly RULE_old_aggr_list = 257;
    static readonly RULE_old_aggr_elem = 258;
    static readonly RULE_opt_enum_val_list = 259;
    static readonly RULE_enum_val_list = 260;
    static readonly RULE_alterenumstmt = 261;
    static readonly RULE_opt_if_not_exists = 262;
    static readonly RULE_createopclassstmt = 263;
    static readonly RULE_opclass_item_list = 264;
    static readonly RULE_opclass_item = 265;
    static readonly RULE_opt_default = 266;
    static readonly RULE_opt_opfamily = 267;
    static readonly RULE_opclass_purpose = 268;
    static readonly RULE_opt_recheck = 269;
    static readonly RULE_createopfamilystmt = 270;
    static readonly RULE_alteropfamilystmt = 271;
    static readonly RULE_opclass_drop_list = 272;
    static readonly RULE_opclass_drop = 273;
    static readonly RULE_reassignownedstmt = 274;
    static readonly RULE_dropstmt = 275;
    static readonly RULE_view_nameList = 276;
    static readonly RULE_object_type_any_name = 277;
    static readonly RULE_object_type_name = 278;
    static readonly RULE_object_type_name_on_any_name = 279;
    static readonly RULE_any_name_list = 280;
    static readonly RULE_relation_column_name = 281;
    static readonly RULE_relation_name = 282;
    static readonly RULE_any_name = 283;
    static readonly RULE_attrs = 284;
    static readonly RULE_type_name_list = 285;
    static readonly RULE_truncatestmt = 286;
    static readonly RULE_truncate_table = 287;
    static readonly RULE_commentstmt = 288;
    static readonly RULE_comment_text = 289;
    static readonly RULE_seclabelstmt = 290;
    static readonly RULE_opt_provider = 291;
    static readonly RULE_security_label = 292;
    static readonly RULE_fetchstmt = 293;
    static readonly RULE_fetch_args = 294;
    static readonly RULE_from_in = 295;
    static readonly RULE_opt_from_in = 296;
    static readonly RULE_grantstmt = 297;
    static readonly RULE_revokestmt = 298;
    static readonly RULE_privileges = 299;
    static readonly RULE_beforeprivilegeselectlist = 300;
    static readonly RULE_beforeprivilegeselect = 301;
    static readonly RULE_privilege_list = 302;
    static readonly RULE_privilege = 303;
    static readonly RULE_privilege_target = 304;
    static readonly RULE_grantee_list = 305;
    static readonly RULE_grantee = 306;
    static readonly RULE_opt_grant_grant_option = 307;
    static readonly RULE_grantrolestmt = 308;
    static readonly RULE_revokerolestmt = 309;
    static readonly RULE_opt_grant_admin_option = 310;
    static readonly RULE_opt_granted_by = 311;
    static readonly RULE_alterdefaultprivilegesstmt = 312;
    static readonly RULE_defacloptionlist = 313;
    static readonly RULE_defacloption = 314;
    static readonly RULE_defaclaction = 315;
    static readonly RULE_defacl_privilege_target = 316;
    static readonly RULE_indexstmt = 317;
    static readonly RULE_opt_unique = 318;
    static readonly RULE_opt_concurrently = 319;
    static readonly RULE_opt_index_name = 320;
    static readonly RULE_access_method_clause = 321;
    static readonly RULE_index_params = 322;
    static readonly RULE_index_elem_options = 323;
    static readonly RULE_index_elem = 324;
    static readonly RULE_opt_include = 325;
    static readonly RULE_index_including_params = 326;
    static readonly RULE_opt_collate = 327;
    static readonly RULE_opt_class = 328;
    static readonly RULE_opt_asc_desc = 329;
    static readonly RULE_opt_nulls_order = 330;
    static readonly RULE_createfunctionstmt = 331;
    static readonly RULE_attrilist = 332;
    static readonly RULE_opt_or_replace = 333;
    static readonly RULE_func_args = 334;
    static readonly RULE_func_args_list = 335;
    static readonly RULE_routine_with_argtypes_list = 336;
    static readonly RULE_routine_with_argtypes = 337;
    static readonly RULE_procedure_with_argtypes_list = 338;
    static readonly RULE_procedure_with_argtypes = 339;
    static readonly RULE_function_with_argtypes_list = 340;
    static readonly RULE_function_with_argtypes = 341;
    static readonly RULE_func_args_with_defaults = 342;
    static readonly RULE_func_args_with_defaults_list = 343;
    static readonly RULE_func_arg = 344;
    static readonly RULE_arg_class = 345;
    static readonly RULE_param_name = 346;
    static readonly RULE_func_return = 347;
    static readonly RULE_func_type = 348;
    static readonly RULE_func_arg_with_default = 349;
    static readonly RULE_aggr_arg = 350;
    static readonly RULE_aggr_args = 351;
    static readonly RULE_aggr_args_list = 352;
    static readonly RULE_aggregate_with_argtypes = 353;
    static readonly RULE_aggregate_with_argtypes_list = 354;
    static readonly RULE_createfunc_opt_list = 355;
    static readonly RULE_common_func_opt_item = 356;
    static readonly RULE_createfunc_opt_item = 357;
    static readonly RULE_transform_type_list = 358;
    static readonly RULE_opt_definition = 359;
    static readonly RULE_table_func_column = 360;
    static readonly RULE_table_func_column_list = 361;
    static readonly RULE_alterfunctionstmt = 362;
    static readonly RULE_alterFunctionTypeClause = 363;
    static readonly RULE_alterfunc_opt_list = 364;
    static readonly RULE_opt_restrict = 365;
    static readonly RULE_removefuncstmt = 366;
    static readonly RULE_removeaggrstmt = 367;
    static readonly RULE_removeoperstmt = 368;
    static readonly RULE_oper_argtypes = 369;
    static readonly RULE_any_operator = 370;
    static readonly RULE_operator_with_argtypes_list = 371;
    static readonly RULE_operator_with_argtypes = 372;
    static readonly RULE_dostmt = 373;
    static readonly RULE_dostmt_opt_list = 374;
    static readonly RULE_dostmt_opt_item = 375;
    static readonly RULE_createcaststmt = 376;
    static readonly RULE_cast_context = 377;
    static readonly RULE_opt_if_exists = 378;
    static readonly RULE_createtransformstmt = 379;
    static readonly RULE_transform_element_list = 380;
    static readonly RULE_reindexstmt = 381;
    static readonly RULE_reindex_target_type = 382;
    static readonly RULE_reindex_target_multitable = 383;
    static readonly RULE_reindex_option_list = 384;
    static readonly RULE_reindex_option_elem = 385;
    static readonly RULE_altertblspcstmt = 386;
    static readonly RULE_renamestmt = 387;
    static readonly RULE_opt_set_data = 388;
    static readonly RULE_alterobjectdependsstmt = 389;
    static readonly RULE_opt_no = 390;
    static readonly RULE_alterobjectschemastmt = 391;
    static readonly RULE_alteroperatorstmt = 392;
    static readonly RULE_operator_def_list = 393;
    static readonly RULE_operator_def_elem = 394;
    static readonly RULE_operator_def_arg = 395;
    static readonly RULE_altertypestmt = 396;
    static readonly RULE_alterownerstmt = 397;
    static readonly RULE_createpublicationstmt = 398;
    static readonly RULE_opt_publication_for_tables = 399;
    static readonly RULE_publication_for_tables = 400;
    static readonly RULE_alterpublicationstmt = 401;
    static readonly RULE_createsubscriptionstmt = 402;
    static readonly RULE_publication_name_list = 403;
    static readonly RULE_publication_name_item = 404;
    static readonly RULE_altersubscriptionstmt = 405;
    static readonly RULE_rulestmt = 406;
    static readonly RULE_ruleactionlist = 407;
    static readonly RULE_ruleactionmulti = 408;
    static readonly RULE_ruleactionstmt = 409;
    static readonly RULE_ruleactionstmtOrEmpty = 410;
    static readonly RULE_event = 411;
    static readonly RULE_opt_instead = 412;
    static readonly RULE_notifystmt = 413;
    static readonly RULE_notify_payload = 414;
    static readonly RULE_listenstmt = 415;
    static readonly RULE_unlistenstmt = 416;
    static readonly RULE_transactionstmt = 417;
    static readonly RULE_opt_transaction = 418;
    static readonly RULE_transaction_mode_item = 419;
    static readonly RULE_transaction_mode_list = 420;
    static readonly RULE_transaction_mode_list_or_empty = 421;
    static readonly RULE_opt_transaction_chain = 422;
    static readonly RULE_viewstmt = 423;
    static readonly RULE_opt_check_option = 424;
    static readonly RULE_loadstmt = 425;
    static readonly RULE_createdbstmt = 426;
    static readonly RULE_createdb_opt_list = 427;
    static readonly RULE_createdb_opt_items = 428;
    static readonly RULE_createdb_opt_item = 429;
    static readonly RULE_createdb_opt_name = 430;
    static readonly RULE_opt_equal = 431;
    static readonly RULE_alterdatabasestmt = 432;
    static readonly RULE_alterdatabasesetstmt = 433;
    static readonly RULE_drop_option_list = 434;
    static readonly RULE_drop_option = 435;
    static readonly RULE_altercollationstmt = 436;
    static readonly RULE_altersystemstmt = 437;
    static readonly RULE_createdomainstmt = 438;
    static readonly RULE_alterdomainstmt = 439;
    static readonly RULE_opt_as = 440;
    static readonly RULE_altertsdictionarystmt = 441;
    static readonly RULE_altertsconfigurationstmt = 442;
    static readonly RULE_any_with = 443;
    static readonly RULE_createconversionstmt = 444;
    static readonly RULE_clusterstmt = 445;
    static readonly RULE_opt_verbose_list = 446;
    static readonly RULE_cluster_index_specification = 447;
    static readonly RULE_vacuumstmt = 448;
    static readonly RULE_analyzestmt = 449;
    static readonly RULE_vac_analyze_option_list = 450;
    static readonly RULE_analyze_keyword = 451;
    static readonly RULE_vac_analyze_option_elem = 452;
    static readonly RULE_vac_analyze_option_name = 453;
    static readonly RULE_vac_analyze_option_arg = 454;
    static readonly RULE_opt_analyze = 455;
    static readonly RULE_analyze_options_list = 456;
    static readonly RULE_analyze_option_elem = 457;
    static readonly RULE_opt_verbose = 458;
    static readonly RULE_opt_skiplock = 459;
    static readonly RULE_opt_buffer_usage_limit = 460;
    static readonly RULE_opt_full = 461;
    static readonly RULE_opt_freeze = 462;
    static readonly RULE_opt_name_list = 463;
    static readonly RULE_vacuum_relation = 464;
    static readonly RULE_vacuum_relation_list = 465;
    static readonly RULE_opt_vacuum_relation_list = 466;
    static readonly RULE_explainstmt = 467;
    static readonly RULE_explainablestmt = 468;
    static readonly RULE_explain_option_list = 469;
    static readonly RULE_explain_option_elem = 470;
    static readonly RULE_explain_option_name = 471;
    static readonly RULE_explain_option_arg = 472;
    static readonly RULE_preparestmt = 473;
    static readonly RULE_prep_type_clause = 474;
    static readonly RULE_preparablestmt = 475;
    static readonly RULE_executestmt = 476;
    static readonly RULE_execute_param_clause = 477;
    static readonly RULE_deallocatestmt = 478;
    static readonly RULE_insertstmt = 479;
    static readonly RULE_insert_target = 480;
    static readonly RULE_insert_rest = 481;
    static readonly RULE_override_kind = 482;
    static readonly RULE_insert_column_list = 483;
    static readonly RULE_insert_column_item = 484;
    static readonly RULE_opt_on_conflict = 485;
    static readonly RULE_opt_conf_expr = 486;
    static readonly RULE_returning_clause = 487;
    static readonly RULE_deletestmt = 488;
    static readonly RULE_using_clause = 489;
    static readonly RULE_lockstmt = 490;
    static readonly RULE_opt_lock = 491;
    static readonly RULE_lock_type = 492;
    static readonly RULE_opt_nowait = 493;
    static readonly RULE_opt_nowait_or_skip = 494;
    static readonly RULE_updatestmt = 495;
    static readonly RULE_set_clause_list = 496;
    static readonly RULE_set_clause = 497;
    static readonly RULE_set_target = 498;
    static readonly RULE_set_target_list = 499;
    static readonly RULE_declarecursorstmt = 500;
    static readonly RULE_cursor_name = 501;
    static readonly RULE_cursor_options = 502;
    static readonly RULE_opt_hold = 503;
    static readonly RULE_selectstmt = 504;
    static readonly RULE_select_with_parens = 505;
    static readonly RULE_select_no_parens = 506;
    static readonly RULE_select_clause = 507;
    static readonly RULE_simple_select = 508;
    static readonly RULE_set_operator = 509;
    static readonly RULE_set_operator_with_all_or_distinct = 510;
    static readonly RULE_with_clause = 511;
    static readonly RULE_cte_list = 512;
    static readonly RULE_common_table_expr = 513;
    static readonly RULE_search_cluase = 514;
    static readonly RULE_cycle_cluase = 515;
    static readonly RULE_opt_materialized = 516;
    static readonly RULE_opt_with_clause = 517;
    static readonly RULE_into_clause = 518;
    static readonly RULE_opt_strict = 519;
    static readonly RULE_opttempTableName = 520;
    static readonly RULE_opt_table = 521;
    static readonly RULE_all_or_distinct = 522;
    static readonly RULE_distinct_clause = 523;
    static readonly RULE_opt_all_clause = 524;
    static readonly RULE_opt_sort_clause = 525;
    static readonly RULE_sort_clause = 526;
    static readonly RULE_sortby_list = 527;
    static readonly RULE_sortby = 528;
    static readonly RULE_select_limit = 529;
    static readonly RULE_opt_select_limit = 530;
    static readonly RULE_limit_clause = 531;
    static readonly RULE_fetch_clause = 532;
    static readonly RULE_offset_clause = 533;
    static readonly RULE_select_limit_value = 534;
    static readonly RULE_select_offset_value = 535;
    static readonly RULE_select_fetch_first_value = 536;
    static readonly RULE_i_or_f_const = 537;
    static readonly RULE_row_or_rows = 538;
    static readonly RULE_first_or_next = 539;
    static readonly RULE_group_clause = 540;
    static readonly RULE_group_by_list = 541;
    static readonly RULE_group_by_item = 542;
    static readonly RULE_empty_grouping_set = 543;
    static readonly RULE_rollup_clause = 544;
    static readonly RULE_cube_clause = 545;
    static readonly RULE_grouping_sets_clause = 546;
    static readonly RULE_having_clause = 547;
    static readonly RULE_for_locking_clause = 548;
    static readonly RULE_opt_for_locking_clause = 549;
    static readonly RULE_for_locking_items = 550;
    static readonly RULE_for_locking_item = 551;
    static readonly RULE_for_locking_strength = 552;
    static readonly RULE_locked_rels_list = 553;
    static readonly RULE_values_clause = 554;
    static readonly RULE_from_clause = 555;
    static readonly RULE_from_list = 556;
    static readonly RULE_table_ref = 557;
    static readonly RULE_alias_clause = 558;
    static readonly RULE_opt_alias_clause = 559;
    static readonly RULE_func_alias_clause = 560;
    static readonly RULE_join_type = 561;
    static readonly RULE_join_qual = 562;
    static readonly RULE_relation_expr = 563;
    static readonly RULE_view_relation_expr = 564;
    static readonly RULE_publication_relation_expr = 565;
    static readonly RULE_relation_expr_list = 566;
    static readonly RULE_publication_relation_expr_list = 567;
    static readonly RULE_relation_expr_opt_alias = 568;
    static readonly RULE_tablesample_clause = 569;
    static readonly RULE_opt_repeatable_clause = 570;
    static readonly RULE_func_table = 571;
    static readonly RULE_rowsfrom_item = 572;
    static readonly RULE_rowsfrom_list = 573;
    static readonly RULE_opt_col_def_list = 574;
    static readonly RULE_opt_ordinality = 575;
    static readonly RULE_where_clause = 576;
    static readonly RULE_where_or_current_clause = 577;
    static readonly RULE_opttablefuncelementlist = 578;
    static readonly RULE_tablefuncelementlist = 579;
    static readonly RULE_tablefuncelement = 580;
    static readonly RULE_xmltable = 581;
    static readonly RULE_xmltable_column_list = 582;
    static readonly RULE_xmltable_column_el = 583;
    static readonly RULE_xmltable_column_option_list = 584;
    static readonly RULE_xmltable_column_option_el = 585;
    static readonly RULE_xml_namespace_list = 586;
    static readonly RULE_xml_namespace_el = 587;
    static readonly RULE_typename = 588;
    static readonly RULE_opt_array_bounds = 589;
    static readonly RULE_simpletypename = 590;
    static readonly RULE_consttypename = 591;
    static readonly RULE_generictype = 592;
    static readonly RULE_opt_type_modifiers = 593;
    static readonly RULE_numeric = 594;
    static readonly RULE_opt_float = 595;
    static readonly RULE_bit = 596;
    static readonly RULE_constbit = 597;
    static readonly RULE_bitwithlength = 598;
    static readonly RULE_bitwithoutlength = 599;
    static readonly RULE_character = 600;
    static readonly RULE_constcharacter = 601;
    static readonly RULE_character_c = 602;
    static readonly RULE_opt_varying = 603;
    static readonly RULE_constdatetime = 604;
    static readonly RULE_constinterval = 605;
    static readonly RULE_opt_timezone = 606;
    static readonly RULE_opt_interval = 607;
    static readonly RULE_interval_second = 608;
    static readonly RULE_opt_escape = 609;
    static readonly RULE_a_expr = 610;
    static readonly RULE_a_expr_qual = 611;
    static readonly RULE_a_expr_lessless = 612;
    static readonly RULE_a_expr_or = 613;
    static readonly RULE_a_expr_and = 614;
    static readonly RULE_a_expr_in = 615;
    static readonly RULE_a_expr_unary_not = 616;
    static readonly RULE_a_expr_isnull = 617;
    static readonly RULE_a_expr_is_not = 618;
    static readonly RULE_a_expr_compare = 619;
    static readonly RULE_a_expr_like = 620;
    static readonly RULE_a_expr_qual_op = 621;
    static readonly RULE_a_expr_unary_qualop = 622;
    static readonly RULE_a_expr_add = 623;
    static readonly RULE_a_expr_mul = 624;
    static readonly RULE_a_expr_caret = 625;
    static readonly RULE_a_expr_unary_sign = 626;
    static readonly RULE_a_expr_at_time_zone = 627;
    static readonly RULE_a_expr_collate = 628;
    static readonly RULE_a_expr_typecast = 629;
    static readonly RULE_b_expr = 630;
    static readonly RULE_c_expr = 631;
    static readonly RULE_plsqlvariablename = 632;
    static readonly RULE_func_application = 633;
    static readonly RULE_func_expr = 634;
    static readonly RULE_func_expr_windowless = 635;
    static readonly RULE_func_expr_common_subexpr = 636;
    static readonly RULE_xml_root_version = 637;
    static readonly RULE_opt_xml_root_standalone = 638;
    static readonly RULE_xml_attributes = 639;
    static readonly RULE_xml_attribute_list = 640;
    static readonly RULE_xml_attribute_el = 641;
    static readonly RULE_document_or_content = 642;
    static readonly RULE_xml_whitespace_option = 643;
    static readonly RULE_xmlexists_argument = 644;
    static readonly RULE_xml_passing_mech = 645;
    static readonly RULE_within_group_clause = 646;
    static readonly RULE_filter_clause = 647;
    static readonly RULE_window_clause = 648;
    static readonly RULE_window_definition_list = 649;
    static readonly RULE_window_definition = 650;
    static readonly RULE_over_clause = 651;
    static readonly RULE_window_specification = 652;
    static readonly RULE_opt_existing_window_name = 653;
    static readonly RULE_opt_partition_clause = 654;
    static readonly RULE_opt_frame_clause = 655;
    static readonly RULE_frame_extent = 656;
    static readonly RULE_frame_bound = 657;
    static readonly RULE_opt_window_exclusion_clause = 658;
    static readonly RULE_row = 659;
    static readonly RULE_explicit_row = 660;
    static readonly RULE_implicit_row = 661;
    static readonly RULE_sub_type = 662;
    static readonly RULE_all_op = 663;
    static readonly RULE_mathop = 664;
    static readonly RULE_qual_op = 665;
    static readonly RULE_qual_all_op = 666;
    static readonly RULE_subquery_Op = 667;
    static readonly RULE_expr_list = 668;
    static readonly RULE_column_expr_list_noparen = 669;
    static readonly RULE_column_expr_list = 670;
    static readonly RULE_column_expr = 671;
    static readonly RULE_column_expr_noparen = 672;
    static readonly RULE_func_arg_list = 673;
    static readonly RULE_func_arg_expr = 674;
    static readonly RULE_type_list = 675;
    static readonly RULE_array_expr = 676;
    static readonly RULE_array_expr_list = 677;
    static readonly RULE_extract_list = 678;
    static readonly RULE_extract_arg = 679;
    static readonly RULE_unicode_normal_form = 680;
    static readonly RULE_overlay_list = 681;
    static readonly RULE_position_list = 682;
    static readonly RULE_substr_list = 683;
    static readonly RULE_trim_list = 684;
    static readonly RULE_in_expr = 685;
    static readonly RULE_case_expr = 686;
    static readonly RULE_when_clause_list = 687;
    static readonly RULE_when_clause = 688;
    static readonly RULE_case_default = 689;
    static readonly RULE_case_arg = 690;
    static readonly RULE_columnref = 691;
    static readonly RULE_indirection_el = 692;
    static readonly RULE_opt_slice_bound = 693;
    static readonly RULE_indirection = 694;
    static readonly RULE_opt_indirection = 695;
    static readonly RULE_opt_target_list = 696;
    static readonly RULE_target_list = 697;
    static readonly RULE_target_el = 698;
    static readonly RULE_qualified_name_list = 699;
    static readonly RULE_table_name_list = 700;
    static readonly RULE_schema_name_list = 701;
    static readonly RULE_database_nameList = 702;
    static readonly RULE_procedure_name_list = 703;
    static readonly RULE_tablespace_name_create = 704;
    static readonly RULE_tablespace_name = 705;
    static readonly RULE_table_name_create = 706;
    static readonly RULE_table_name = 707;
    static readonly RULE_view_name_create = 708;
    static readonly RULE_view_name = 709;
    static readonly RULE_qualified_name = 710;
    static readonly RULE_tablespace_name_list = 711;
    static readonly RULE_name_list = 712;
    static readonly RULE_database_name_create = 713;
    static readonly RULE_database_name = 714;
    static readonly RULE_schema_name = 715;
    static readonly RULE_routine_name_create = 716;
    static readonly RULE_routine_name = 717;
    static readonly RULE_procedure_name = 718;
    static readonly RULE_procedure_name_create = 719;
    static readonly RULE_column_name = 720;
    static readonly RULE_column_name_create = 721;
    static readonly RULE_name = 722;
    static readonly RULE_attr_name = 723;
    static readonly RULE_file_name = 724;
    static readonly RULE_function_name_create = 725;
    static readonly RULE_function_name = 726;
    static readonly RULE_usual_name = 727;
    static readonly RULE_aexprconst = 728;
    static readonly RULE_xconst = 729;
    static readonly RULE_bconst = 730;
    static readonly RULE_fconst = 731;
    static readonly RULE_iconst = 732;
    static readonly RULE_sconst = 733;
    static readonly RULE_anysconst = 734;
    static readonly RULE_opt_uescape = 735;
    static readonly RULE_signediconst = 736;
    static readonly RULE_groupname = 737;
    static readonly RULE_roleid = 738;
    static readonly RULE_rolespec = 739;
    static readonly RULE_role_list = 740;
    static readonly RULE_colid = 741;
    static readonly RULE_index_method_choices = 742;
    static readonly RULE_exclude_element = 743;
    static readonly RULE_index_paramenters = 744;
    static readonly RULE_type_function_name = 745;
    static readonly RULE_type_usual_name = 746;
    static readonly RULE_nonreservedword_column = 747;
    static readonly RULE_nonreservedword = 748;
    static readonly RULE_collabel = 749;
    static readonly RULE_identifier = 750;
    static readonly RULE_plsqlidentifier = 751;
    static readonly RULE_unreserved_keyword = 752;
    static readonly RULE_col_name_keyword = 753;
    static readonly RULE_type_func_name_keyword = 754;
    static readonly RULE_reserved_keyword = 755;
    static readonly RULE_pl_function = 756;
    static readonly RULE_comp_options = 757;
    static readonly RULE_comp_option = 758;
    static readonly RULE_sharp = 759;
    static readonly RULE_option_value = 760;
    static readonly RULE_opt_semi = 761;
    static readonly RULE_pl_block = 762;
    static readonly RULE_decl_sect = 763;
    static readonly RULE_decl_start = 764;
    static readonly RULE_decl_stmts = 765;
    static readonly RULE_label_decl = 766;
    static readonly RULE_decl_stmt = 767;
    static readonly RULE_decl_statement = 768;
    static readonly RULE_opt_scrollable = 769;
    static readonly RULE_decl_cursor_query = 770;
    static readonly RULE_decl_cursor_args = 771;
    static readonly RULE_decl_cursor_arglist = 772;
    static readonly RULE_decl_cursor_arg = 773;
    static readonly RULE_decl_is_for = 774;
    static readonly RULE_decl_aliasitem = 775;
    static readonly RULE_decl_varname = 776;
    static readonly RULE_decl_const = 777;
    static readonly RULE_decl_datatype = 778;
    static readonly RULE_decl_collate = 779;
    static readonly RULE_decl_notnull = 780;
    static readonly RULE_decl_defval = 781;
    static readonly RULE_decl_defkey = 782;
    static readonly RULE_assign_operator = 783;
    static readonly RULE_proc_sect = 784;
    static readonly RULE_proc_stmt = 785;
    static readonly RULE_stmt_perform = 786;
    static readonly RULE_stmt_call = 787;
    static readonly RULE_opt_expr_list = 788;
    static readonly RULE_stmt_assign = 789;
    static readonly RULE_stmt_getdiag = 790;
    static readonly RULE_getdiag_area_opt = 791;
    static readonly RULE_getdiag_list = 792;
    static readonly RULE_getdiag_list_item = 793;
    static readonly RULE_getdiag_item = 794;
    static readonly RULE_getdiag_target = 795;
    static readonly RULE_assign_var = 796;
    static readonly RULE_stmt_if = 797;
    static readonly RULE_stmt_elsifs = 798;
    static readonly RULE_stmt_else = 799;
    static readonly RULE_stmt_case = 800;
    static readonly RULE_opt_expr_until_when = 801;
    static readonly RULE_case_when_list = 802;
    static readonly RULE_case_when = 803;
    static readonly RULE_opt_case_else = 804;
    static readonly RULE_stmt_loop = 805;
    static readonly RULE_stmt_while = 806;
    static readonly RULE_stmt_for = 807;
    static readonly RULE_for_control = 808;
    static readonly RULE_opt_for_using_expression = 809;
    static readonly RULE_opt_cursor_parameters = 810;
    static readonly RULE_opt_reverse = 811;
    static readonly RULE_opt_by_expression = 812;
    static readonly RULE_for_variable = 813;
    static readonly RULE_stmt_foreach_a = 814;
    static readonly RULE_foreach_slice = 815;
    static readonly RULE_stmt_exit = 816;
    static readonly RULE_exit_type = 817;
    static readonly RULE_stmt_return = 818;
    static readonly RULE_opt_return_result = 819;
    static readonly RULE_stmt_raise = 820;
    static readonly RULE_opt_stmt_raise_level = 821;
    static readonly RULE_opt_raise_list = 822;
    static readonly RULE_opt_raise_using = 823;
    static readonly RULE_opt_raise_using_elem = 824;
    static readonly RULE_opt_raise_using_elem_list = 825;
    static readonly RULE_stmt_assert = 826;
    static readonly RULE_opt_stmt_assert_message = 827;
    static readonly RULE_loop_body = 828;
    static readonly RULE_stmt_execsql = 829;
    static readonly RULE_stmt_dynexecute = 830;
    static readonly RULE_opt_execute_using = 831;
    static readonly RULE_opt_execute_using_list = 832;
    static readonly RULE_opt_execute_into = 833;
    static readonly RULE_stmt_open = 834;
    static readonly RULE_opt_open_bound_list_item = 835;
    static readonly RULE_opt_open_bound_list = 836;
    static readonly RULE_opt_open_using = 837;
    static readonly RULE_opt_scroll_option = 838;
    static readonly RULE_opt_scroll_option_no = 839;
    static readonly RULE_stmt_fetch = 840;
    static readonly RULE_into_target = 841;
    static readonly RULE_opt_cursor_from = 842;
    static readonly RULE_opt_fetch_direction = 843;
    static readonly RULE_stmt_move = 844;
    static readonly RULE_mergestmt = 845;
    static readonly RULE_data_source = 846;
    static readonly RULE_join_condition = 847;
    static readonly RULE_merge_when_clause = 848;
    static readonly RULE_merge_insert = 849;
    static readonly RULE_merge_update = 850;
    static readonly RULE_default_values_or_values = 851;
    static readonly RULE_exprofdefaultlist = 852;
    static readonly RULE_exprofdefault = 853;
    static readonly RULE_stmt_close = 854;
    static readonly RULE_stmt_null = 855;
    static readonly RULE_stmt_commit = 856;
    static readonly RULE_stmt_rollback = 857;
    static readonly RULE_plsql_opt_transaction_chain = 858;
    static readonly RULE_stmt_set = 859;
    static readonly RULE_cursor_variable = 860;
    static readonly RULE_exception_sect = 861;
    static readonly RULE_proc_exceptions = 862;
    static readonly RULE_proc_exception = 863;
    static readonly RULE_proc_conditions = 864;
    static readonly RULE_proc_condition = 865;
    static readonly RULE_opt_block_label = 866;
    static readonly RULE_opt_loop_label = 867;
    static readonly RULE_opt_label = 868;
    static readonly RULE_opt_exitcond = 869;
    static readonly RULE_any_identifier = 870;
    static readonly RULE_plsql_unreserved_keyword = 871;
    static readonly RULE_sql_expression = 872;
    static readonly RULE_expr_until_then = 873;
    static readonly RULE_expr_until_semi = 874;
    static readonly RULE_expr_until_rightbracket = 875;
    static readonly RULE_expr_until_loop = 876;
    static readonly RULE_make_execsql_stmt = 877;
    static readonly RULE_opt_returning_clause_into = 878;
...
export declare class ProgramContext extends antlr.ParserRuleContext {
    ...
    enterRule(listener: DuckDBParserListener): void;
    exitRule(listener: DuckDBParserListener): void;
    accept<Result>(visitor: DuckDBParserVisitor<Result>): Result | null;
}
...
export declare class StmtContext extends antlr.ParserRuleContext {
    ...
    pragmastmt(): PragmastmtContext | null;
...
export declare class PragmastmtContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    KW_PRAGMA(): antlr.TerminalNode;
    pragma_name(): Pragma_nameContext;
    schema_name(): Schema_nameContext | null;
    DOT(): antlr.TerminalNode | null;
