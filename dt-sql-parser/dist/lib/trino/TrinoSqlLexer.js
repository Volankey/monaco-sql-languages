...
class TrinoSqlLexer extends antlr.Lexer {
    constructor(input) {
        super(input);
    ...
    get literalNames() { return TrinoSqlLexer.literalNames; }
    get symbolicNames() { return TrinoSqlLexer.symbolicNames; }
    get ruleNames() { return TrinoSqlLexer.ruleNames; }
    get serializedATN() { return TrinoSqlLexer._serializedATN; }
    get channelNames() { return TrinoSqlLexer.channelNames; }
    get modeNames() { return TrinoSqlLexer.modeNames; }
    static get _ATN() {
...
TrinoSqlLexer.T__0 = 1;
TrinoSqlLexer.T__1 = 2;
TrinoSqlLexer.T__2 = 3;
TrinoSqlLexer.T__3 = 4;
TrinoSqlLexer.T__4 = 5;
TrinoSqlLexer.T__5 = 6;
TrinoSqlLexer.T__6 = 7;
TrinoSqlLexer.T__7 = 8;
TrinoSqlLexer.T__8 = 9;
TrinoSqlLexer.T__9 = 10;
TrinoSqlLexer.T__10 = 11;
TrinoSqlLexer.T__11 = 12;
TrinoSqlLexer.T__12 = 13;
TrinoSqlLexer.T__13 = 14;
TrinoSqlLexer.T__14 = 15;
TrinoSqlLexer.T__15 = 16;
TrinoSqlLexer.KW_ADD = 17;
TrinoSqlLexer.KW_ADMIN = 18;
TrinoSqlLexer.KW_AFTER = 19;
TrinoSqlLexer.KW_ALL = 20;
TrinoSqlLexer.KW_ALTER = 21;
TrinoSqlLexer.KW_ANALYZE = 22;
TrinoSqlLexer.KW_AND = 23;
TrinoSqlLexer.KW_ANY = 24;
TrinoSqlLexer.KW_ARRAY = 25;
TrinoSqlLexer.KW_AS = 26;
TrinoSqlLexer.KW_ASC = 27;
TrinoSqlLexer.KW_AT = 28;
TrinoSqlLexer.KW_AUTHORIZATION = 29;
TrinoSqlLexer.KW_BERNOULLI = 30;
TrinoSqlLexer.KW_BETWEEN = 31;
TrinoSqlLexer.KW_BY = 32;
TrinoSqlLexer.KW_CALL = 33;
TrinoSqlLexer.KW_CASCADE = 34;
TrinoSqlLexer.KW_CASE = 35;
TrinoSqlLexer.KW_CAST = 36;
TrinoSqlLexer.KW_CATALOGS = 37;
TrinoSqlLexer.KW_COLUMN = 38;
TrinoSqlLexer.KW_COLUMNS = 39;
TrinoSqlLexer.KW_COMMENT = 40;
TrinoSqlLexer.KW_COMMIT = 41;
TrinoSqlLexer.KW_COMMITTED = 42;
TrinoSqlLexer.KW_CONSTRAINT = 43;
TrinoSqlLexer.KW_CREATE = 44;
TrinoSqlLexer.KW_CROSS = 45;
TrinoSqlLexer.KW_CUBE = 46;
TrinoSqlLexer.KW_CURRENT = 47;
TrinoSqlLexer.KW_CURRENT_CATALOG = 48;
TrinoSqlLexer.KW_CURRENT_DATE = 49;
TrinoSqlLexer.KW_CURRENT_PATH = 50;
TrinoSqlLexer.KW_CURRENT_ROLE = 51;
TrinoSqlLexer.KW_CURRENT_SCHEMA = 52;
TrinoSqlLexer.KW_CURRENT_TIME = 53;
TrinoSqlLexer.KW_CURRENT_TIMESTAMP = 54;
TrinoSqlLexer.KW_CURRENT_USER = 55;
TrinoSqlLexer.KW_DATA = 56;
TrinoSqlLexer.KW_DATE = 57;
TrinoSqlLexer.KW_DAY = 58;
TrinoSqlLexer.KW_DEFAULT = 59;
TrinoSqlLexer.KW_DEALLOCATE = 60;
TrinoSqlLexer.KW_DEFINER = 61;
TrinoSqlLexer.KW_DELETE = 62;
TrinoSqlLexer.KW_DESC = 63;
TrinoSqlLexer.KW_DESCRIBE = 64;
TrinoSqlLexer.KW_DEFINE = 65;
TrinoSqlLexer.KW_DISTINCT = 66;
TrinoSqlLexer.KW_DISTRIBUTED = 67;
TrinoSqlLexer.KW_DOUBLE = 68;
TrinoSqlLexer.KW_DROP = 69;
TrinoSqlLexer.KW_ELSE = 70;
TrinoSqlLexer.KW_EMPTY = 71;
TrinoSqlLexer.KW_END = 72;
TrinoSqlLexer.KW_ESCAPE = 73;
TrinoSqlLexer.KW_EXCEPT = 74;
TrinoSqlLexer.KW_EXCLUDING = 75;
TrinoSqlLexer.KW_EXECUTE = 76;
TrinoSqlLexer.KW_EXISTS = 77;
TrinoSqlLexer.KW_EXPLAIN = 78;
TrinoSqlLexer.KW_EXTRACT = 79;
TrinoSqlLexer.KW_FALSE = 80;
TrinoSqlLexer.KW_FETCH = 81;
TrinoSqlLexer.KW_FILTER = 82;
TrinoSqlLexer.KW_FINAL = 83;
TrinoSqlLexer.KW_FIRST = 84;
TrinoSqlLexer.KW_FOLLOWING = 85;
TrinoSqlLexer.KW_FOR = 86;
TrinoSqlLexer.KW_FORMAT = 87;
TrinoSqlLexer.KW_FROM = 88;
TrinoSqlLexer.KW_FULL = 89;
TrinoSqlLexer.KW_FUNCTIONS = 90;
TrinoSqlLexer.KW_GRANT = 91;
TrinoSqlLexer.KW_GRANTED = 92;
TrinoSqlLexer.KW_GRANTS = 93;
TrinoSqlLexer.KW_DENY = 94;
TrinoSqlLexer.KW_GRAPHVIZ = 95;
TrinoSqlLexer.KW_GROUP = 96;
TrinoSqlLexer.KW_GROUPING = 97;
TrinoSqlLexer.KW_GROUPS = 98;
TrinoSqlLexer.KW_HAVING = 99;
TrinoSqlLexer.KW_HOUR = 100;
TrinoSqlLexer.KW_IF = 101;
TrinoSqlLexer.KW_IGNORE = 102;
TrinoSqlLexer.KW_IN = 103;
TrinoSqlLexer.KW_INCLUDING = 104;
TrinoSqlLexer.KW_INITIAL = 105;
TrinoSqlLexer.KW_INNER = 106;
TrinoSqlLexer.KW_INPUT = 107;
TrinoSqlLexer.KW_INSERT = 108;
TrinoSqlLexer.KW_INTERSECT = 109;
TrinoSqlLexer.KW_INTERVAL = 110;
TrinoSqlLexer.KW_INTO = 111;
TrinoSqlLexer.KW_INVOKER = 112;
TrinoSqlLexer.KW_IO = 113;
TrinoSqlLexer.KW_IS = 114;
TrinoSqlLexer.KW_ISOLATION = 115;
TrinoSqlLexer.KW_JOIN = 116;
TrinoSqlLexer.KW_JSON = 117;
TrinoSqlLexer.KW_LAST = 118;
TrinoSqlLexer.KW_LATERAL = 119;
TrinoSqlLexer.KW_LEFT = 120;
TrinoSqlLexer.KW_LEVEL = 121;
TrinoSqlLexer.KW_LIKE = 122;
TrinoSqlLexer.KW_LIMIT = 123;
TrinoSqlLexer.KW_LOCAL = 124;
TrinoSqlLexer.KW_LOCALTIME = 125;
TrinoSqlLexer.KW_LOCALTIMESTAMP = 126;
TrinoSqlLexer.KW_LOGICAL = 127;
TrinoSqlLexer.KW_MAP = 128;
TrinoSqlLexer.KW_MATCH = 129;
TrinoSqlLexer.KW_MATCHED = 130;
TrinoSqlLexer.KW_MATCHES = 131;
TrinoSqlLexer.KW_MATCH_RECOGNIZE = 132;
TrinoSqlLexer.KW_MATERIALIZED = 133;
TrinoSqlLexer.KW_MEASURES = 134;
TrinoSqlLexer.KW_MERGE = 135;
TrinoSqlLexer.KW_MINUTE = 136;
TrinoSqlLexer.KW_MONTH = 137;
TrinoSqlLexer.KW_NATURAL = 138;
TrinoSqlLexer.KW_NEXT = 139;
TrinoSqlLexer.KW_NFC = 140;
TrinoSqlLexer.KW_NFD = 141;
TrinoSqlLexer.KW_NFKC = 142;
TrinoSqlLexer.KW_NFKD = 143;
TrinoSqlLexer.KW_NO = 144;
TrinoSqlLexer.KW_NONE = 145;
TrinoSqlLexer.KW_NORMALIZE = 146;
TrinoSqlLexer.KW_NOT = 147;
TrinoSqlLexer.KW_NULL = 148;
TrinoSqlLexer.KW_NULLIF = 149;
TrinoSqlLexer.KW_NULLS = 150;
TrinoSqlLexer.KW_OFFSET = 151;
TrinoSqlLexer.KW_OMIT = 152;
TrinoSqlLexer.KW_ON = 153;
TrinoSqlLexer.KW_ONE = 154;
TrinoSqlLexer.KW_ONLY = 155;
TrinoSqlLexer.KW_OPTION = 156;
TrinoSqlLexer.KW_OR = 157;
TrinoSqlLexer.KW_ORDER = 158;
TrinoSqlLexer.KW_ORDINALITY = 159;
TrinoSqlLexer.KW_OUTER = 160;
TrinoSqlLexer.KW_OUTPUT = 161;
TrinoSqlLexer.KW_OVER = 162;
TrinoSqlLexer.KW_PARTITION = 163;
TrinoSqlLexer.KW_PARTITIONS = 164;
TrinoSqlLexer.KW_PAST = 165;
TrinoSqlLexer.KW_PATH = 166;
TrinoSqlLexer.KW_PATTERN = 167;
TrinoSqlLexer.KW_PER = 168;
TrinoSqlLexer.KW_PERMUTE = 169;
TrinoSqlLexer.KW_POSITION = 170;
TrinoSqlLexer.KW_PRECEDING = 171;
TrinoSqlLexer.KW_PRECISION = 172;
TrinoSqlLexer.KW_PREPARE = 173;
TrinoSqlLexer.KW_PRIVILEGES = 174;
TrinoSqlLexer.KW_PROPERTIES = 175;
TrinoSqlLexer.KW_RANGE = 176;
TrinoSqlLexer.KW_READ = 177;
TrinoSqlLexer.KW_RECURSIVE = 178;
TrinoSqlLexer.KW_REFRESH = 179;
TrinoSqlLexer.KW_RENAME = 180;
TrinoSqlLexer.KW_REPEATABLE = 181;
TrinoSqlLexer.KW_REPLACE = 182;
TrinoSqlLexer.KW_RESET = 183;
TrinoSqlLexer.KW_RESPECT = 184;
TrinoSqlLexer.KW_RESTRICT = 185;
TrinoSqlLexer.KW_REVOKE = 186;
TrinoSqlLexer.KW_RIGHT = 187;
TrinoSqlLexer.KW_ROLE = 188;
TrinoSqlLexer.KW_ROLES = 189;
TrinoSqlLexer.KW_ROLLBACK = 190;
TrinoSqlLexer.KW_ROLLUP = 191;
TrinoSqlLexer.KW_ROW = 192;
TrinoSqlLexer.KW_ROWS = 193;
TrinoSqlLexer.KW_RUNNING = 194;
TrinoSqlLexer.KW_SCHEMA = 195;
TrinoSqlLexer.KW_SCHEMAS = 196;
TrinoSqlLexer.KW_SECOND = 197;
TrinoSqlLexer.KW_SECURITY = 198;
TrinoSqlLexer.KW_SEEK = 199;
TrinoSqlLexer.KW_SELECT = 200;
TrinoSqlLexer.KW_SERIALIZABLE = 201;
TrinoSqlLexer.KW_SESSION = 202;
TrinoSqlLexer.KW_SET = 203;
TrinoSqlLexer.KW_SETS = 204;
TrinoSqlLexer.KW_SHOW = 205;
TrinoSqlLexer.KW_SOME = 206;
TrinoSqlLexer.KW_START = 207;
TrinoSqlLexer.KW_STATS = 208;
TrinoSqlLexer.KW_SUBSET = 209;
TrinoSqlLexer.KW_SUBSTRING = 210;
TrinoSqlLexer.KW_SYSTEM = 211;
TrinoSqlLexer.KW_TABLE = 212;
TrinoSqlLexer.KW_TABLES = 213;
TrinoSqlLexer.KW_TABLESAMPLE = 214;
TrinoSqlLexer.KW_TEXT = 215;
TrinoSqlLexer.KW_THEN = 216;
TrinoSqlLexer.KW_TIES = 217;
TrinoSqlLexer.KW_TIME = 218;
TrinoSqlLexer.KW_TIMESTAMP = 219;
TrinoSqlLexer.KW_TO = 220;
TrinoSqlLexer.KW_TRANSACTION = 221;
TrinoSqlLexer.KW_TRUNCATE = 222;
TrinoSqlLexer.KW_TRUE = 223;
TrinoSqlLexer.KW_TRY_CAST = 224;
TrinoSqlLexer.KW_TYPE = 225;
TrinoSqlLexer.KW_UESCAPE = 226;
TrinoSqlLexer.KW_UNBOUNDED = 227;
TrinoSqlLexer.KW_UNCOMMITTED = 228;
TrinoSqlLexer.KW_UNION = 229;
TrinoSqlLexer.KW_UNMATCHED = 230;
TrinoSqlLexer.KW_UNNEST = 231;
TrinoSqlLexer.KW_UPDATE = 232;
TrinoSqlLexer.KW_USE = 233;
TrinoSqlLexer.KW_USER = 234;
TrinoSqlLexer.KW_USING = 235;
TrinoSqlLexer.KW_VALIDATE = 236;
TrinoSqlLexer.KW_VALUES = 237;
TrinoSqlLexer.KW_VERBOSE = 238;
TrinoSqlLexer.KW_VIEW = 239;
TrinoSqlLexer.KW_WHEN = 240;
TrinoSqlLexer.KW_WHERE = 241;
TrinoSqlLexer.KW_WINDOW = 242;
TrinoSqlLexer.KW_WITH = 243;
TrinoSqlLexer.KW_WITHOUT = 244;
TrinoSqlLexer.KW_WORK = 245;
TrinoSqlLexer.KW_WRITE = 246;
TrinoSqlLexer.KW_YEAR = 247;
TrinoSqlLexer.KW_ZONE = 248;
TrinoSqlLexer.EQ = 249;
TrinoSqlLexer.NEQ = 250;
TrinoSqlLexer.LT = 251;
TrinoSqlLexer.LTE = 252;
TrinoSqlLexer.GT = 253;
TrinoSqlLexer.GTE = 254;
TrinoSqlLexer.PLUS = 255;
TrinoSqlLexer.MINUS = 256;
TrinoSqlLexer.ASTERISK = 257;
TrinoSqlLexer.SLASH = 258;
TrinoSqlLexer.PERCENT = 259;
TrinoSqlLexer.CONCAT = 260;
TrinoSqlLexer.QUESTION_MARK = 261;
TrinoSqlLexer.STRING = 262;
TrinoSqlLexer.UNICODE_STRING = 263;
TrinoSqlLexer.BINARY_LITERAL = 264;
TrinoSqlLexer.INTEGER_VALUE = 265;
TrinoSqlLexer.DECIMAL_VALUE = 266;
TrinoSqlLexer.DOUBLE_VALUE = 267;
TrinoSqlLexer.IDENTIFIER = 268;
TrinoSqlLexer.DIGIT_IDENTIFIER = 269;
TrinoSqlLexer.QUOTED_IDENTIFIER = 270;
TrinoSqlLexer.BACKQUOTED_IDENTIFIER = 271;
TrinoSqlLexer.SEMICOLON = 272;
TrinoSqlLexer.SIMPLE_COMMENT = 273;
TrinoSqlLexer.BRACKETED_COMMENT = 274;
TrinoSqlLexer.WS = 275;
TrinoSqlLexer.UNRECOGNIZED = 276;
TrinoSqlLexer.channelNames = [
    "DEFAULT_TOKEN_CHANNEL", "HIDDEN"
];
TrinoSqlLexer.literalNames = [
    null, "'('", "')'", "','", "'.'", "'SKIP'", "'->'", "'['", "']'",
    "'|'", "'^'", "'$'", "'{-'", "'-}'", "'{'", "'}'", "'=>'", "'ADD'",
...
TrinoSqlLexer.modeNames = [
    "DEFAULT_MODE",
];
TrinoSqlLexer.ruleNames = [
...
TrinoSqlLexer.vocabulary = new antlr.Vocabulary(TrinoSqlLexer.literalNames, TrinoSqlLexer.symbolicNames, []);
TrinoSqlLexer.decisionsToDFA = TrinoSqlLexer._ATN.decisionToState.map((ds, index) => new antlr.DFA(ds, index));
export { TrinoSqlLexer };
