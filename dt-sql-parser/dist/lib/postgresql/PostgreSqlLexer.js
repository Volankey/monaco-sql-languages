...
class PostgreSqlLexer extends antlr.Lexer {
    constructor(input) {
        super(input);
...
PostgreSqlLexer.Identifier = 549;
PostgreSqlLexer.QuotedIdentifier = 550;
PostgreSqlLexer.UnterminatedQuotedIdentifier = 551;
PostgreSqlLexer.InvalidQuotedIdentifier = 552;
PostgreSqlLexer.InvalidUnterminatedQuotedIdentifier = 553;
PostgreSqlLexer.UnicodeQuotedIdentifier = 554;
PostgreSqlLexer.UnterminatedUnicodeQuotedIdentifier = 555;
PostgreSqlLexer.InvalidUnicodeQuotedIdentifier = 556;
PostgreSqlLexer.InvalidUnterminatedUnicodeQuotedIdentifier = 557;
PostgreSqlLexer.StringConstant = 558;
PostgreSqlLexer.UnterminatedStringConstant = 559;
PostgreSqlLexer.UnicodeEscapeStringConstant = 560;
PostgreSqlLexer.UnterminatedUnicodeEscapeStringConstant = 561;
PostgreSqlLexer.BeginDollarStringConstant = 562;
PostgreSqlLexer.BinaryStringConstant = 563;
PostgreSqlLexer.UnterminatedBinaryStringConstant = 564;
PostgreSqlLexer.InvalidBinaryStringConstant = 565;
PostgreSqlLexer.InvalidUnterminatedBinaryStringConstant = 566;
PostgreSqlLexer.HexadecimalStringConstant = 567;
PostgreSqlLexer.UnterminatedHexadecimalStringConstant = 568;
PostgreSqlLexer.InvalidHexadecimalStringConstant = 569;
PostgreSqlLexer.InvalidUnterminatedHexadecimalStringConstant = 570;
PostgreSqlLexer.Integral = 571;
PostgreSqlLexer.NumericFail = 572;
PostgreSqlLexer.Numeric = 573;
PostgreSqlLexer.PLSQLVARIABLENAME = 574;
PostgreSqlLexer.PLSQLIDENTIFIER = 575;
PostgreSqlLexer.Whitespace = 576;
PostgreSqlLexer.Newline = 577;
PostgreSqlLexer.LineComment = 578;
PostgreSqlLexer.BlockComment = 579;
PostgreSqlLexer.UnterminatedBlockComment = 580;
PostgreSqlLexer.MetaCommand = 581;
PostgreSqlLexer.EndMetaCommand = 582;
PostgreSqlLexer.ErrorCharacter = 583;
PostgreSqlLexer.EscapeStringConstant = 584;
PostgreSqlLexer.UnterminatedEscapeStringConstant = 585;
PostgreSqlLexer.InvalidEscapeStringConstant = 586;
PostgreSqlLexer.InvalidUnterminatedEscapeStringConstant = 587;
PostgreSqlLexer.DollarText = 588;
PostgreSqlLexer.EndDollarStringConstant = 589;
PostgreSqlLexer.AfterEscapeStringConstantWithNewlineMode_Continued = 590;
...
PostgreSqlLexer.vocabulary = new antlr.Vocabulary(PostgreSqlLexer.literalNames, PostgreSqlLexer.symbolicNames, []);
PostgreSqlLexer.decisionsToDFA = PostgreSqlLexer._ATN.decisionToState.map((ds, index) => new antlr.DFA(ds, index));
export { PostgreSqlLexer };
