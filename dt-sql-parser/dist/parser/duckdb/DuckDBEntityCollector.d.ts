import type { ColumnCreateTableContext, ColumnNameCreateContext, CreateDatabaseContext, CreateForeignTableContext, CreateMaterializedViewContext, CreatePartitionForeignTableContext, CreateViewContext, CreatefunctionstmtContext, DatabaseNameContext, DatabaseNameCreateContext, FunctionNameCreateContext, InsertStatementContext, QueryCreateTableContext, SelectStatementContext, SingleStmtContext, TableNameContext, TableNameCreateContext, ViewNameContext, ViewNameCreateContext } from '../../lib/duckdb/DuckDBParser';
import type { DuckDBParserListener } from '../../lib/duckdb/DuckDBParserListener';
import { EntityCollector } from '../common/entityCollector';
export declare class DuckDBEntityCollector extends EntityCollector implements DuckDBParserListener {
    /** ====== Entity Begin */
